...
for iter = 1:2 % change to 2
    ...
    x_simu(:,:,iter) = x_real + [whiteNoiseGen(size(x_real,2),1,simga_x_GPS); whiteNoiseGen(size(x_real,2),1,simga_y_GPS)];
...
fprintf(fileID,'Real GPS Positioning [m]& %3.6f  \\\\ \\hline \n', stdGPS );
